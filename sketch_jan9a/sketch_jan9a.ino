...
float desired_position0 = 8.263561;
float position_error1;
float sensed_position1;
float desired_position1 = 13.405681;
...
void setup() {
  ...
  /* We will determine sensed_position0 and sensed_position1 from response with a function */
  sensed_position0 = get_sensed_position(response, 0);
  sensed_position1 = get_sensed_position(response, 1);
  // Serial.print(sensed_position0);
...
void loop() {
  ...
  sensed_position1 = get_sensed_position(response, 1);
  // Serial.print(sensed_position0);
  // Serial.println(sensed_position1);
  ...
  */
  ...
  // Serial.print("Mandatory print: " + response);
  // Serial.print(response);
  // Serial.print(sensed_position0);
  // Serial.print(" ");
  // Serial.print(sensed_position1);
  // Serial.print(" ");
  Serial.println(solenoid_command0);
  // Serial.print(" ");
  // Serial.print(solenoid_command1);
  // Serial.print(" ");
